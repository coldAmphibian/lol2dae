...
// Global Variables:
FileLocation inLocation, outLocation;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hWnd = CreateWindow(szWindowClass, szTitle, WS_OVERLAPPED | WS_SYSMENU, CW_USEDEFAULT, 0, 500, 300, NULL, NULL, hInstance, NULL);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		hConvertButton = CreateWindow(_T("button"), _T("Convert"), WS_VISIBLE | WS_CHILD | WS_BORDER | WS_TABSTOP | BS_CENTER | BS_VCENTER, 215, 210, 100, 32, hWnd, (HMENU)139, NULL, NULL);
		SendMessage(hConvertButton, WM_SETFONT, (WPARAM)getFont(), TRUE);

		hExitButton = CreateWindow(_T("button"), _T("Exit"), WS_VISIBLE | WS_CHILD | WS_BORDER | WS_TABSTOP | BS_CENTER | BS_VCENTER, 335, 210, 100, 32, hWnd, (HMENU)140, NULL, NULL);
